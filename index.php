...
<head>
    ...
    <script src="js/tabs.js" defer charset="utf-8"></script>
</head>
...
<body>
    ...
    <div id="carousel" class="carousel-wrapper" data-carousel="1" data-speed="3000">
        <span class="carousel-control-left"></span>
        <span class="carousel-control-right"></span>
        <div class="carousel-content">
            <img width="100%" height="100%" srcset="assets/laptop.webp" src="assets/laptop.webp" alt="image 1"
                loading="lazy" />
            <img width="100%" height="100%" srcset="assets/welcome.webp" src="assets/welcome.webp" alt="image 5"
                loading="lazy" />
            <img width="100%" height="100%" srcset="assets/cantor_building.webp" src="assets/cantor_building.webp"
                alt="image 5" loading="lazy" />
        </div>
    </div>
    <div id="tabs">
        <section id="featured-programs" class="heading animated-element color-changing-element">
            <div class="container">
                <h2>Featured Programs</h2>
                <p>Discover the pinnacle of academic excellence and state-of-the art facilities at Cantor College</p>
            </div>
            <div class="tabs">
                <button class="tab-btn tab-link is-active" data-tab="global-leadership">Global Leadership MBA</button>
                <button class="tab-btn tab-link" data-tab="innovation-technology">Bachelor of Innovation in
                    Technology</button>
                <button class="tab-btn tab-link" data-tab="communication-media-arts">Communication and Media
                    Arts</button>
            </div>
        </section>


        <section id="content-section" class="tab-content is-active">
            <div class="container">
                <div class="flex-box">
                    <div class="description">
                        <h3>Global Leadership MBA</h3>
                        <span>Elevate your leadership prowess with our Global Leadership MBA. Immerse yourself in a
                            diverse
                            learning environment and shape your global perspective for impactful business
                            leadership.</span>
                    ...
                    <picture>
                        ...
                        <img width="100%" height="100%" src="assets/bsit1.webp"
                            alt="Global Leadership MBA Program Image">
                    </picture>
            ...
            <div class="container">
                <div class="flex-box">
                    <picture>
                        ...
                        <img width="100%" height="100%" src="assets/bsit.webp"
                            alt="Bachelor of Innovation in Technology Program Image">
                    </picture>
                    <div class="description">
        ...
        <section id="communication-media-arts" class="tab-content">
            <div class="container">
                <div class="flex-box">
                    ...
                    <picture>
                        <source srcset="assets/bsit.webp" type="image/webp">
                        <img width="100%" height="100%" src="assets/media1.webp"
                            alt="Communication and Media Arts Program Image">
                    </picture>
                </div>
            </div>
        </section>
        ...
        <section id="content-section">
            <div class="container">
                <section id="philosophy" class="heading animated-element">
                    <div class="container color-changing-element">
                ...
                <section class="content-sections">
                    ...
                    <h2>Our Philosophy</h2>
                    <p>We’re a creative university. We get excited about change, difference, and the possibilities they
                        open
                        up. From the arts to business to technology, we’re all about shaping the future of creativity,
                        and
                    ...
                    <p>The creative industries are global and highly connected, and so are we. We’re proud of our
                        diverse
                        culture and international links - they’re the reason our graduates can go anywhere and still
                        feel
                        they
                        belong.</p>
                    <br>
